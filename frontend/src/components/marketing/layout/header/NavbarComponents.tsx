...
export function CustomNavbarDropdownButton({href, icon, title, description}: CustomNavbarDropdownButtonProps) {
  return (
    <Link href={href} className="flex flex-row gap-3 group p-2 rounded-sm transition-all group">
        {/* Icon container */}
        <div className="w-10 h-10 shrink-0 rounded-md bg-muted border flex items-center justify-center">
            {icon}
        </div>
...
export function CustomNavbarDropdownButtonAlternative({href, icon, title, description}: CustomNavbarDropdownButtonProps) {
  return (
    <Link href={href} className="flex flex-row gap-3 group p-2 rounded-sm transition-all group">
        {/* Icon container */}
        <div className="w-8 h-8 shrink-0 rounded-md bg-transparent border flex items-center justify-center">
            {icon}
        </div>
