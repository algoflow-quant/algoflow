    ...
    <div className="p-6">
      <div className="pointer-events-none z-10 flex transform-gpu gap-3 items-start transition-all duration-500 ease-in-out lg:group-hover:translate-y-[calc(100%-3rem)]">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="max-w-lg text-sm text-neutral-400 opacity-100 transition-all duration-500 ease-in-out lg:group-hover:opacity-0 lg:group-hover:translate-y-8">{description}</p>
        </div>
      </div>
