...
from sec_data_pipeline.yfinance import YfinancePipeline, YfinanceTickerScraper, YfinanceValidator
...
def yfinance_historical_parallel():
    ...
    def get_tickers(**context):
        ...
        ticker_scraper = YfinanceTickerScraper()

        # Map source names to their scraper methods
        TICKER_SOURCES = {
            'sp500': ticker_scraper.scrape_sp500_tickers,
            'russell3000': ticker_scraper.scrape_russell3000_tickers,
            'nasdaq': ticker_scraper.scrape_nasdaq_tickers,
        }
